const AdminFooter = () => {
  return (
    <div className=" w-screen">
        <footer className="bg-white w-full shadow sm:flex sm:items-center sm:justify-between p-4 sm:p-6 xl:p-8 dark:bg-gray-800 antialiased">
  <p className="mb-4 text-sm text-center text-gray-500 dark:text-gray-400 sm:mb-0">
      &copy; 2019-2022 <a href="https://flowbite.com/" className="hover:underline" >Guru Nanak Dev Engineering College</a>. All rights reserved.
  </p>
